...
with plt.style.context("default"):
    ...
    n, bins, patches = axs[0].hist(ytr,n_classes,rwidth=0.5, alpha = 0.8)
    ...
    n, bins, patches = axs[1].hist(yts,n_classes,rwidth=0.5, alpha = 0.8)
    bin_w = (max(bins) - min(bins)) / (len(bins) - 1)
    ...
    plt.tight_layout()
    plt.savefig('FIGURES/trainTestDist_cnn_10fold_4_classes.pdf')
...
# Save history
reports_4_fn = ('REPORTS/reportsCNN_4.p')
...
with plt.style.context("default"):
    ...
    plt.grid
    plt.savefig('FIGURES/accTrainVal_10foldCV_4classes.pdf')
...
plt.tight_layout()
plt.savefig('FIGURES/normCM_cnn_10fold_4_classes.pdf')
...
with plt.style.context("default"):
    ...
    plt.tight_layout()
    plt.savefig('FIGURES/accuracyTrainVal_cnn_10fold_4_classes.pdf')
